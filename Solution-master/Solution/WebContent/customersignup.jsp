    ...
    <section class="container-fluid bg">
        <div class="row justify-content-center">
            <div class="col-12 col-sm-6 col-md-3">
                <form class="form-container" action="AuthticationServlet" method="post">
                <input type="hidden" name="action" value="customersignup">
                    <h3 class="text-center">Customer Sign Up
                    </h3>
                <div class="form-group">

                        <label for="exampleInputPassword1">Name</label>
                        <input type="text" name='cname' class="form-control" id="a-z" placeholder="Full Name">
                      </div>
                ...
                <div class="form-group">
                        ...
                        <input type="number" name='pno' class="form-control" id="1-9" placeholder="Mobile No.">
                      </div>
...
<label>Name</label><input type='text' name='cname'><br><br>
