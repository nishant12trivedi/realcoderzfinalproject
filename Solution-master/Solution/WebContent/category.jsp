...
<header>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link">Category<span class="sr-only">(current)</span></a>
                          </li>
                          <li class="nav-item active">
	...
	List<String> category = new DBMImp().getAllCategory();
	Iterator<String> itr1 = category.iterator();
	while(itr1.hasNext()){
	String tcat=new String(itr1.next());
	%>
	
	<div class="col-lg-2 col-md-4 col-sm-12 mb-4 ">
                    <div class="card" style="width: 10rem;">
                            <img class="card-img-top img-fluid" src="images/<%= tcat%>.jpg" alt="Card image cap">
                            <div class="card-body">
                              <a href="list.jsp?category=<%= tcat%>"><p class="card-text text-center text-capitalize"><%= tcat%></p></a>
                            </div>
                          </div>
                </div>		
	<% 				
